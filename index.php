...
<html>
<head>
<title>Chassi - Leyzer | Web Site </title>
				...
				<div class="col-md-7 banner-bottom-grid-text">
					<div class="jumbotron banner-bottom-left wow fadeInLeft animated" data-wow-delay="0.5s" style="visibility: visible; -webkit-animation-delay: 0.5s;	">
					  <h3>Perfil</h3>
						...
						<p>Hoje a empresa atende todo o estado do Paraná, inclusive parte do estado de São Paulo.

há mais de 25 anos no mercado a Chassi Leyzer possui grande experiência e tecnologia para atender os mais diversos casos.

Focada no futuro, a empresa tem procurado o que há de mais moderno no mercado, oferecendo aos seus clientes tecnologia de ponta.</p>
						<div class="see-button">
							<a class="btn btn-primary btn-lg see-button hvr-shutter-out-horizontal" href="#" role="button">ChassiLeyzer 25 Anos</a>
							<br>
							<br>
	...
	<div class="specialty">
		...
		<div class="container" id="servicos">
			<div class="col-md-5 specialty-info wow fadeInLeft animated" data-wow-delay="0.5s" style="visibility: visible; -webkit-animation-delay: 0.5s;">
				...
				<br>
<br>
				<b>Desempenamento e Alinhamento</b> de chassi de veículos leves e pesados para todas as marcas. 
...
Sistema de desempenamento totalmente a frio, utilizando equipamento computadorizado.
					...
					<br>
					<br><b>Serviços de molejos, molas, pinos, buchas, estirantes, balanças e suporte em geral</b>
					<br>
					<br>
					Parte de chassi, soldas, troca de suportes e travessas em geral.

<br>
					<br>

Serviços de auto-socorro
Com dois ginchos pesados.
				</p>
				<div class="see-button">
					<a class="btn btn-primary btn-lg see-button hvr-shutter-out-horizontal specialty-button" href="#" role="button">Peça um Orçamento</a>
				</div>
			</div>
			<div class="col-md-7 specialty-grids">
				...
				<div class="specialty-grids-top">
					<div class="col-md-6 service-box wow fadeInRight animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
						...
						<h5>Molas</h5>
						<p>Serviços de molas em geral</p>
					</div>
					<div class="col-md-6 service-box wow fadeInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
						<figure class="icon">
							<img src="images/4.png" alt="" />
						</figure>
						<h5>Parte de Alinhamento</h5>
						<p>Alinhamento de carretas, balanças, pinos estirantes, borrachas e suportes.</p>
					</div>
					<div class="clearfix"> </div>
				</div>
				<br>
		...
		<div class="container" id="local">
			...
			<div class="mail-grids">
				<div class="col-md-6 mail-grid-left wow fadeInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h3>Contato</h3>
					<h5>Contato para orçamentos, preencha os dados no campo direito  </h5>
					<h4>Endereço</h4>
	...
	<div class="footer">
		...
		<div class="container" id="contato">
			...
			<div class="col-md-3 footer-right  wow fadeInRight animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
				<a href="#"><img src="images/original.png" alt="" /></a>
				<p>A empresa fundada em 1989 é pioneira no ramo no norte do Paraná.</p>
			</div>
			<div class="clearfix"> </div>	
		</div>
		<!-- //container -->
	...
	<div class="copyright">
		...
		<div class="container">
			<div class="copyright-left wow fadeInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
				<p>© 2018 ChassiLeyzer. Design by <a href="http://web17.com.br/site">Agência Web17</a></p>
			</div>
